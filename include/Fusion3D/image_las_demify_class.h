#ifndef _image_las_demify_class_h_
#define _image_las_demify_class_h_
#ifdef __cplusplus
...
*/
class image_las_demify_class:public image_las_class{
 private:
   ...
   int *idata;					// Surface -- intensity unscaled
   ...
   int alloc_flag;				// Surface -- allocated array level -- set to point data type when alloc done
...
#endif /* __cplusplus */
#endif /* _image_las_demify_class_h_ */

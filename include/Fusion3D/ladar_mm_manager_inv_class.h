...
class ladar_mm_manager_inv_class:public ladar_mm_manager_class{
   private:
	  ...
	  SoSFFloat*		GL_mobmap_filt_amin;///< OIV Global -- Filter on absolute elevation - min 
	  SoSFFloat*		GL_mobmap_filt_amax;///< OIV Global -- Filter on absolute elevation - max 
	  SoSFFloat*		GL_mobmap_filt_rmin;///< OIV Global -- Filter on relative elevation - min 
	  SoSFFloat*		GL_mobmap_filt_rmax;///< OIV Global -- Filter on relative elevation - max 
	  ...
	  SoSFInt32*		GL_mobmap_fine_cur;	///< OIV Global -- Current filter value (min TAU or max elevation)
